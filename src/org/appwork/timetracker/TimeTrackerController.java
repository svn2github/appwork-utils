...
public class TimeTrackerController {
    ...
    private ConcurrentHashMap<String, TimeTracker> map;

    /**
     * Create a new instance of TimeTrackerController. This is a singleton class. Access the only existing instance by using
     * {@link #getInstance()}.
     */
    public TimeTrackerController() {
        map = new ConcurrentHashMap<String, TimeTracker>();
    }
