    ...
    public JComponent layoutDialogContent() {
        ...
        color.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                Color newColor = JColorChooser.showDialog(color, "Choose Color", color.getBackground());
    ...
    protected synchronized void query(String searchTags, Style style) {
        ...
        try {
            ...
            if (style == null || style == Style.ALL) {
                xml = br.getPage(new URL("https://api.icons8.com/api/iconsets/search?term=" + URLEncode.encodeRFC2396(searchTags) + "&amount=100"));
            } else {
                xml = br.getPage(new URL("https://api.icons8.com/api/iconsets/search?term=" + URLEncode.encodeRFC2396(searchTags) + "&amount=100" + "&platform=" + URLEncode.encodeRFC2396(style.getKey())));
            }
