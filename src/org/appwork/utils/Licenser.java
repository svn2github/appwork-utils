...
public class Licenser {
    public static void main(String[] args) throws URISyntaxException, IOException {
        ...
        File file = new File(new File(Application.class.getResource("Application.class").toURI()).getParentFile().getParentFile().getParentFile().getParentFile().getParentFile(), "src");
        final String license = IO.readFileToString(new File(file.getParentFile(), "License AppWork Utilities.txt"));
        final StringBuilder sb = new StringBuilder();
        sb.append("/**");
        for (String line : Regex.getLines(license)) {
            sb.append("\r\n");
            sb.append(" * ");
            sb.append(line);
        }
