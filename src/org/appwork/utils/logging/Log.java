 ...
 * @date 17.03.2016
 *
 *       needed for old webinstallers, https://board.jdownloader.org/showthread.php?t=68509
 */
@Deprecated
public class Log {

    private final static Logger LOGGER = init();

    private static Logger init() {
        final Logger logger = Logger.getLogger("org.appwork");
