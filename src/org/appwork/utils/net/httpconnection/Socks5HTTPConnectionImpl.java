...
public class Socks5HTTPConnectionImpl extends SocksHTTPconnection {
    ...
    protected SocketStreamInterface connect(SocketStreamInterface socketStream) throws IOException {
        ...
        ((Socks5SocketConnection) socket).connect(this.proxyInetSocketAddress = new InetSocketAddress(getHostname(), this.httpPort), this.getConnectTimeout(), this.proxyRequest);
        return socketStream;
    }
}
